...
class InimigoChefe(pygame.sprite.Sprite):
    ...
    def explosion_death(self): # a ideia é, quando o chefe morrer, parar ele e aplicar umas animações de explosão
        ...
        for _ in range (5) : # 5 explosoes
            ...
            pygame.mixer.Sound('Explosion3__005.ogg').play(_)

class Explosao(pygame.sprite.Sprite):
    def __init__(self) :
        super().__init__()
        self.sprite_sheet = pygame.image.load('explosion.png')
...
class Estrela(pygame.sprite.Sprite):
    def __init__(self, x, y):
        self.image = pygame.image.load('final-star-removebg-preview.png')
